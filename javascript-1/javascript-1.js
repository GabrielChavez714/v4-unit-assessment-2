...
for (i = 0; i < lettersToPair.length; i++) {
    for (k = i + 1; k < lettersToPair.length; k++) {
...
/*
    ...
    and push that trick into a tricks array and return the updated array.
...
//CODE HERE
let phone1 = new Phone('Sprint', 'iphone', 128, 'red', false);

let phone2 = new Phone('T-mobile', 'iphone', 50, 'black', false);

let phone3 = new Phone('At&t', 'iphone', 500, 'white', false);
